...
All supported functions can be called from Octave/Matlab with the
...
- `int mpfr_fmodquo (mpfr_t r, long* q, mpfr_t x, mpfr_t y, mpfr_rnd_t rnd)`
  ...
  > Note: The interface is changed to
  > `[returned_int_value, q] = mpfr_('mpfr_fmodquo', r, x, y, rnd);`
...
- `int mpfr_remquo (mpfr_t r, long* q, mpfr_t x, mpfr_t y, mpfr_rnd_t rnd)`
  ...
  > Note: The interface is changed to
  > `[returned_int_value, q] = mpfr_('mpfr_remquo', r, x, y, rnd);`
